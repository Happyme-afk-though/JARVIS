...
def speak(text):
    try:
        ...
        sleep_duration = min(0.1 + len(text) // 20, 50)  # Minimum sleep is 3 seconds, maximum is 3600 seconds
...
while True:
    if percent < 29 and percent > 0 and not plugged:
        speak("sir, the battery is low, you should turn on the charger.")
        time.sleep(20)
    ...
    elif percent < 29 and percent > 0 and plugged:
        time.sleep(3900)
        os.startfile("C:\\Users\\u\\Desktop\\and all\\updated jarvis\\battery_reminder.py")
        time.sleep(1)
        pg.hotkey('alt', 'tab')
    ...
    elif percent > 90 and percent <100 and plugged:
        speak("sir, the battery is above 90 percent, you should turn off the charger.")
        time.sleep(20)
        os.startfile("C:\\Users\\u\\Desktop\\and all\\updated jarvis\\battery_reminder.py")
        time.sleep(1)
        pg.hotkey('alt', 'tab')
    ...
    elif percent > 90 and percent <100 and not plugged:
        time.sleep(4000)
        os.startfile("C:\\Users\\u\\Desktop\\and all\\updated jarvis\\battery_reminder.py")
        time.sleep(1)
        pg.hotkey('alt', 'tab')
    ...
    elif percent>29 and percent <90:
        time.sleep(900)
        os.startfile("C:\\Users\\u\\Desktop\\and all\\updated jarvis\\battery_reminder.py")
        time.sleep(1)
        pg.hotkey('alt', 'tab')
