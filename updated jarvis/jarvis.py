...
os.startfile("C:\\Users\\u\\Desktop\\and all\\updated jarvis\\battery_reminder.py")
time.sleep(1)
pg.hotkey('alt', 'tab')
...
chrome_driver_path = r'C:\\Users\\u\\Desktop\\and all\\updated jarvis\\chromedriver.exe'
...
def wishMe():
    ...
    if hour>=0 and hour<10:
        speak("good morning sir, how you would like to start your day today.")
        ...
        speak("good to see you back home sir, how can i help you")
...
if __name__ == "__main__":
    ...
    # if 1:
        ...
        if "youtube" in query:
            ...
            remember1 = open('C:\\Users\\u\\Desktop\\and all\\updated jarvis\\data.txt','r')
            ...
            remember1 = open('C:\\Users\\u\\Desktop\\and all\\updated jarvis\\data.txt','w')
            ...
            speak('ok sir')
            time.sleep(1.6)
            os.startfile("C:\\Users\\u\\Desktop\\and all\\updated jarvis\\hotward.py")
            time.sleep(1)
            pg.hotkey('alt', 'tab')
            break
            ...
            im1 = open('C:\\Users\\u\\Desktop\\and all\\updated jarvis\\img1.txt','w')
            im1.write(query)
            im1.close()
            speak("anything else you would like to add?")
        elif "yes add" in query:
            query = query.replace('yes add','')
            im1 = open('C:\\Users\\u\\Desktop\\and all\\updated jarvis\\img2.txt','w')                
            im1.write(query)
            im1.close()
            speak("generating your image")
            os.startfile('C:\\Users\\u\\Desktop\\and all\\updated jarvis\\img2.txt')
            time.sleep(1)
            pg.hotkey("ctrl", "a")
            pg.hotkey("ctrl", "c")
            os.startfile('C:\\Users\\u\\Desktop\\and all\\updated jarvis\\img1.txt')
            time.sleep(1)
            pg.hotkey('end')
            time.sleep(0.5)
            pg.hotkey("ctrl", "v")
